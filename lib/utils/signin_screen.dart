...
class _EmailLinkSignInSectionState extends State<_EmailLinkSignInSection> {
  ...
  Future<void> _signInWithEmailAndLink() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('An email has been sent to $_userEmail')));
    } catch (e) {
      print(e);
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Sending email failed')));
    }
  }
}
...
class _AnonymouslySignInSectionState extends State<_AnonymouslySignInSection> {
  ...
  Future<void> _signInAnonymously() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Signed in Anonymously as user ${user.uid}')));
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
...
class _OtherProvidersSignInSectionState
  ...
  Future<void> _signInWithGithub() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Sign In ${user.uid} with GitHub')));
    } catch (e) {
      print(e);
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _signInWithFacebook() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Sign In ${user.uid} with Facebook')));
    } catch (e) {
      print(e);
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _signInWithTwitter() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Sign In ${user.uid} with Twitter')));
    } catch (e) {
      print(e);
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to sign in with Twitter: $e')));
    }
  }
